      ...
      <CardHeader className="bg-white rounded-xl p-4 mb-4">
        <div className="flex flex-col gap-5 lg:flex-row lg:justify-between lg:items-center">
          ...
          <div className="flex gap-2">
            <Link
              href={`/app/${orgId}/scheduler?week=${prevWeek}&year=${prevYear}`}
            >
              <Button>
            ...
            <Link
              href={`/app/${orgId}/scheduler?week=${currentWeek}&year=${currentYear}`}
            >
              <Button>This Week</Button>
            </Link>
            <Link
              href={`/app/${orgId}/scheduler?week=${nextWeek}&year=${nextYear}`}
            >
              <Button>
                Next
