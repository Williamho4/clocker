...
import {
  adminGetAllAttedancesForDateSchema,
...
export const adminGetAllAttedancesForDate = async (data: unknown) => {
  checkIfAdmin();

  const validatedData = adminGetAllAttedancesForDateSchema.safeParse(data);
